...
class Realisasi_HD_Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data = array(
            ...
            'tanggaran_llpbph'    => AnggaranModel::join('tb_rekening', 'tb_rekening.id_rekening', 'tb_anggaran.id_rekening')->where('tb_rekening.no_rekening', '6.1.08.01.04.0001')->sum('nilai'),
            'tanggaran_llppihakke3'    => AnggaranModel::join('tb_rekening', 'tb_rekening.id_rekening', 'tb_anggaran.id_rekening')->where('tb_rekening.no_rekening', '6.1.08.02.01.0001')->sum('nilai'),
            ...
            'tanggaran_ptdaknfkesetaraankin'    => AnggaranModel::join('tb_rekening', 'tb_rekening.id_rekening', 'tb_anggaran.id_rekening')->where('tb_rekening.no_rekening', '4.2.01.09.02.0031')->sum('nilai'),
            ...
            'total_ptdaknfkesetaraankin'    => bkusModel::join('tb_rekening', 'tb_rekening.id_rekening', 'tb_transaksi.id_rekening')->where('tb_rekening.no_rekening', '4.2.01.09.02.0031')->sum('nilai_transaksi'),
