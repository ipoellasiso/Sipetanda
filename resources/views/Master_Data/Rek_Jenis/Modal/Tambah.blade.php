        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="userForm" name="userForm" enctype="multipart/form-data">
                    <div class="modal-body">
                        <input type="text" name="id" id="id6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Id Akun</label>
                                    <input type="text" class="form-control" name="id_akun" id="id_akun" value="" placeholder="" required>
                                </div>
                                <div class="form-group">
                                    <label>Id Kelompok</label>
                                    <input type="text" class="form-control" name="id_kelompok" id="id_kelompok" value="" placeholder="" required>
                                </div>
                                <div class="form-group">
