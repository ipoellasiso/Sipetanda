            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-1">
                            <div class="btn-group dropdown me-1 mb-1">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                    <a class="dropdown-item" href="javascript:void(0)" id="createRekobjek">Tambah Data</a>
                                    <a class="dropdown-item" id="createimportrekobjek" href="#">Upload Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="m-t-25 table-responsive">
                        <table id="data-table" class="tabelrekobjek table table-hover" style="width:100%">
                            <thead>
                                <tr>
...
@include('Master_Data.Rek_Objek.Modal.import')
@include('Master_Data.Rek_Objek.Fungsi.Fungsi')
@include('Master_Data.Rek_Objek.Modal.Tambah')
