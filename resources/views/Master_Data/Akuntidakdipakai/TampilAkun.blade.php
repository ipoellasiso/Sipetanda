            ...
            <div class="col-md-1 text-right">
                <div class="btn-group dropdown me-1 mb-1">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                        <a class="dropdown-item" href="javascript:void(0)" id="createAkun">Tambah Data</a>
...
@include('Master_Data.Akun.Modal.Tambah')
@include('Master_Data.Akun.Modal.import')
@include('Master_Data.Akun.Fungsi.Fungsi')
@endsection