            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-1">
                            <div class="btn-group dropdown me-1 mb-1">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                    <a class="dropdown-item" href="javascript:void(0)" id="createReksubrincianobjek">Tambah Data</a>
                                    <a class="dropdown-item" id="createimportreksubrincianobjek" href="#">Upload Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="m-t-25 table-responsive">
                        <table id="data-table" class="tabelreksubrincianobjek table table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th class="text-center" width="10px">No</th>
                                    <th class="text-center" width="100px">Akun</th>
                                    <th class="text-center" width="100px">Kelompok</th>
                                    <th class="text-center" width="100px">Jenis</th>
                                    <th class="text-center" width="100px">Objek</th>
                                    <th class="text-center" width="100px">Rincian Objek</th>
...
@include('Master_Data.Rek_Subrincianobjek.Modal.import')
@include('Master_Data.Rek_Subrincianobjek.Fungsi.Fungsi')
@include('Master_Data.Rek_Subrincianobjek.Modal.Tambah')
