            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-1">
                            <div class="btn-group dropdown me-1 mb-1">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
                                    <a class="dropdown-item" href="javascript:void(0)" id="createRekkelompok">Tambah Data</a>
                                    <a class="dropdown-item" id="createimportrekkelompok" href="#">Upload Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="m-t-25 table-responsive">
                        <table id="data-table" class="tabelrekkelompok table table-hover" style="width:100%">
                            <thead>
                                <tr>
...
@include('Master_Data.Rek_Kelompok.Modal.import')
@include('Master_Data.Rek_Kelompok.Fungsi.Fungsi')
@include('Master_Data.Rek_Kelompok.Modal.Tambah')
