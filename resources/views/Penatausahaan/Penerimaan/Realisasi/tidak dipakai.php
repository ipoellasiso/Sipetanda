...
@section('content')
    ...
    <div class="card">
    <div class="card-header border border-dange table table-striped table-primary">
        ...
        <div class="card-body" id="pad">
            <div class="card table table-striped table-primary table-bordered">
                <div class="">
                    <h5 class="card-title table table-striped">

                        {{-- PENDAPATAN DAERAH --}}
                        <div class="collapsed " data-bs-toggle="collapse" href="#collapsellpd">
                            <div class="row">
                                <div class="col-md-5">
                        ...
                        <div id="collapsellpd" class="collapse" data-parent="#pad">
                            <div class="" id="pad1">
                                <div class="collapsed" data-bs-toggle="collapse" href="#collapsellpad1">
                                    <div class="row">
                        ...
                        <div id="collapsellpd" class="collapse" data-parent="#pad">
                            <div class="" id="pt1">
                                <div class="collapsed" data-bs-toggle="collapse" href="#collapsept1">
                                    <div class="row">
                                        <div class="col-md-5 table-bordered">
                        ...
                        <div id="collapsellpd" class="collapse" data-parent="#pad">
                            <div class="" id="llp1">
                                <div class="collapsed" data-bs-toggle="collapse" href="#collapsellp1">
                                    <div class="row">
                                        <div class="col-md-5 table-bordered">
